...
int button_state;
int previous_button_state = false;
int32_t previous_detect_time = 0;
int32_t last_button_time = 0;
int32_t button_debounce_delay = 50;
...
void loop() {
  ...
  // Fetch button state
  bool reading = digitalRead(P1_11);
  if (reading != previous_button_state) {
    last_button_time = millis();
  }

  // Debounce the button state
  if ((millis() - last_button_time) > button_debounce_delay) {
